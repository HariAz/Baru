...
<div id="page-content" class="container-fluid">
    ...
    <div id="mainContent" style="display: none;">
        <form class="audit-form" method="post" action="{{ route('proses_audit') }}">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" name="submit_action" value="submit" class="btn btn-success">Submit</button>
                    <button type="submit" name="submit_action" value="cancel" class="btn btn-danger">Cancel</button>
                </div>
            </div>
        </form>
    </div>
