            ...
            <ul class="list-unstyled components p-3">
                <li class="nav-item dropdown">
                    ...
                    <ul class="collapse list-unstyled" id="conductAuditSubmenu">
                        <li><a href="{{ route('audit_checklist.create') }}"><i class="fas fa-plus-circle mr-2"></i>Create Audit Checklist</a></li>
                        <li><a href="{{ route('audit_checklist.update') }}"><i class="fas fa-edit mr-2"></i>Update Audit Checklist</a></li>
